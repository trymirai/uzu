...
impl VkTimestampQueryPool {
    ...
    pub fn write(&mut self, command_buffer: vk::CommandBuffer) {
    ...
    pub fn get_duration_nanos(&self, period_position: u32) -> f64 {
    ...
    fn compute_duration_nanos(&self, start: u64, finish: u64) -> f64 {
