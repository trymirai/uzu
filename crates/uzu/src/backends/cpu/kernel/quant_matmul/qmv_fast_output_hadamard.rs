...
#[kernel(QuantizedMatmulQmvFastOutputHadamard)]
#[variants(T, f32, f16, bf16)]
#[variants(GROUP_SIZE, 32, 64, 128)]
#[variants(BITS, 4, 8)]
pub fn quantized_matmul_qmv_fast_output_hadamard<T: ArrayElement + Float, const GROUP_SIZE: i32, const BITS: i32>(
    ...
    #[allow(unused)] output_factors: *const T,
    #[allow(unused)] k: i32,
    #[allow(unused)] n: i32,
    #[allow(unused)] m: i32,
    #[allow(unused)]
