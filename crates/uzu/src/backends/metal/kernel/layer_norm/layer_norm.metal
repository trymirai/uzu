...
void layer_norm_core(
    ...
    AccumT total_sum = threadgroup_cooperative_reduce_sum<BLOCK_SIZE>(partial_sum, shared_mean, thread_in_row);
    ...
    AccumT total_var = threadgroup_cooperative_reduce_sum<BLOCK_SIZE>(partial_var_sum, shared_variance, thread_in_row);
