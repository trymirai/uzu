...
impl Kernel {
    ...
    pub fn precompile(
        ...
        let configs: &[PipelineConfiguration] = match self.data_type {
            DataType::BF16 => &[
                PipelineConfiguration { block_rows: 64, block_cols: 32, block_depth: 32, warps_per_row: 2, warps_per_col: 2, swizzle_log2: 0, align_m: false, align_n: true, align_k: true },
                PipelineConfiguration { block_rows: 64, block_cols: 32, block_depth: 32, warps_per_row: 2, warps_per_col: 2, swizzle_log2: 0, align_m: true, align_n: true, align_k: true },
                PipelineConfiguration { block_rows: 64, block_cols: 64, block_depth: 16, warps_per_row: 2, warps_per_col: 2, swizzle_log2: 0, align_m: false, align_n: true, align_k: true },
                PipelineConfiguration { block_rows: 64, block_cols: 64, block_depth: 16, warps_per_row: 2, warps_per_col: 2, swizzle_log2: 0, align_m: true, align_n: false, align_k: true },
                PipelineConfiguration { block_rows: 64, block_cols: 64, block_depth: 16, warps_per_row: 2, warps_per_col: 2, swizzle_log2: 0, align_m: true, align_n: true, align_k: true },
                PipelineConfiguration { block_rows: 64, block_cols: 64, block_depth: 16, warps_per_row: 1, warps_per_col: 2, swizzle_log2: 0, align_m: true, align_n: true, align_k: true },
            ],
            DataType::F16 => &[
                PipelineConfiguration { block_rows: 64, block_cols: 64, block_depth: 16, warps_per_row: 2, warps_per_col: 2, swizzle_log2: 0, align_m: true, align_n: true, align_k: true },
                PipelineConfiguration { block_rows: 64, block_cols: 64, block_depth: 16, warps_per_row: 2, warps_per_col: 2, swizzle_log2: 0, align_m: false, align_n: true, align_k: true },
            ...
            DataType::F32 => &[
                PipelineConfiguration { block_rows: 32, block_cols: 64, block_depth: 16, warps_per_row: 1, warps_per_col: 2, swizzle_log2: 0, align_m: false, align_n: true, align_k: true },
                PipelineConfiguration { block_rows: 32, block_cols: 64, block_depth: 16, warps_per_row: 1, warps_per_col: 2, swizzle_log2: 0, align_m: true, align_n: true, align_k: true },
            ],
            _ => &[],
        };
