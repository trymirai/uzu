...
pub struct Conv1dSwishForwardKernel {
    pipeline: MTLComputePipelineState,
}

pub struct Conv1dSwishForwardArguments<'a> {
...
impl Conv1dSwishForwardKernel {
    pub fn new(
        context: &MTLContext,
        data_type: KernelDataType,
    ) -> Result<Self, SSMKernelError> {
        let fn_name =
            format!("conv1d_swish_forward_kernel_{}", fn_suffix(data_type));
    ...
    pub fn encode(
        ...
        args: Conv1dSwishForwardArguments,
