...
quantized_embedding_lookup<float, 2, false>(
...
template [[host_name("quantized_embedding_lookup_f16_uint4")]] [[kernel]] void
quantized_embedding_lookup<half, 2, false>(
    const device uint64_t* token_ids [[buffer(0)]],
    const device uint8_t* weights [[buffer(1)]],
...
template [[host_name("quantized_embedding_lookup_bf16_uint4")]] [[kernel]] void
quantized_embedding_lookup<bfloat, 2, false>(
    const device uint64_t* token_ids [[buffer(0)]],
    const device uint8_t* weights [[buffer(1)]],
...
template [[host_name("quantized_embedding_lookup_f32_int8")]] [[kernel]] void
quantized_embedding_lookup<float, 1, true>(
    const device uint64_t* token_ids [[buffer(0)]],
    const device uint8_t* weights [[buffer(1)]],
    const device float* scales [[buffer(2)]],
    const device float* biases [[buffer(3)]],
...
template [[host_name("quantized_embedding_lookup_f16_int8")]] [[kernel]] void
quantized_embedding_lookup<half, 1, true>(
    const device uint64_t* token_ids [[buffer(0)]],
    const device uint8_t* weights [[buffer(1)]],
    const device half* scales [[buffer(2)]],
    const device half* biases [[buffer(3)]],
...
template [[host_name("quantized_embedding_lookup_bf16_int8")]] [[kernel]] void
quantized_embedding_lookup<bfloat, 1, true>(
    const device uint64_t* token_ids [[buffer(0)]],
    const device uint8_t* weights [[buffer(1)]],
    const device bfloat* scales [[buffer(2)]],
    const device bfloat* biases [[buffer(3)]],
...
template [[host_name("quantized_embedding_lookup_f32_uint8")]] [[kernel]] void
quantized_embedding_lookup<float, 1, false>(
    const device uint64_t* token_ids [[buffer(0)]],
    const device uint8_t* weights [[buffer(1)]],
    const device float* scales [[buffer(2)]],
    const device float* biases [[buffer(3)]],
...
template [[host_name("quantized_embedding_lookup_f16_uint8")]] [[kernel]] void
quantized_embedding_lookup<half, 1, false>(
    const device uint64_t* token_ids [[buffer(0)]],
    const device uint8_t* weights [[buffer(1)]],
    const device half* scales [[buffer(2)]],
    const device half* biases [[buffer(3)]],
...
template [[host_name("quantized_embedding_lookup_bf16_uint8")]] [[kernel]] void
quantized_embedding_lookup<bfloat, 1, false>(
    const device uint64_t* token_ids [[buffer(0)]],
    const device uint8_t* weights [[buffer(1)]],
    const device bfloat* scales [[buffer(2)]],
    const device bfloat* biases [[buffer(3)]],
