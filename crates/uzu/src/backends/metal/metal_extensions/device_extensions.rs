...
pub trait DeviceExt: MTLDevice + Message {
    ...
    /// Selector `familyName` on `_MTLDevice`.
    ...
    /// Examples: M1=8, M1 Pro=16, M1 Max=32, M2 Max=38, M4 Pro=20.
    ...
    /// When true, MPP cooperative tensors use the native hardware layout.
