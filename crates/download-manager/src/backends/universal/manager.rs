...
impl FileDownloadManager for UniversalDownloadManager {
    ...
    async fn file_download_task(
        ...
        let resume_artifact_path = destination_path.with_extension("part");
