...
- **Provider layer** — the user-facing generic API (`Instant<M>`, `Interval<M>`).
...
**`Instant<M>`** — a single read of device facts and instantaneous gauges: chip/core counts,
RAM total and usage, temperatures, voltage/current, fans, battery, thermal pressure, rail
