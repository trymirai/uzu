  ...
  if (process.env.NAPI_RS_NATIVE_LIBRARY_PATH) {
    ...
    if (process.arch === 'arm64') {
      ...
      try {
        ...
        if (bindingPackageVersion !== '0.5.30' && process.env.NAPI_RS_ENFORCE_VERSION_CHECK && process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0') {
          throw new Error(`Native binding package version mismatch, expected 0.5.30 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`)
        }
        return binding
      } catch (e) {
        loadErrors.push(e)
...
module.exports.ChatReplyEnergyComponents = nativeBinding.ChatReplyEnergyComponents
module.exports.ChatReplyEnergyTotal = nativeBinding.ChatReplyEnergyTotal
module.exports.ChatReplyJoulesPerTokenComponents = nativeBinding.ChatReplyJoulesPerTokenComponents
module.exports.ChatReplyJoulesPerTokenTotal = nativeBinding.ChatReplyJoulesPerTokenTotal
...
module.exports.ModelAccessibilityOnDevice = nativeBinding.ModelAccessibilityOnDevice
...
module.exports.ModelSourceFilesystem = nativeBinding.ModelSourceFilesystem
module.exports.ModelSourceRegistry = nativeBinding.ModelSourceRegistry
