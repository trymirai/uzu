 ...
 */
export declare class ChatInstance {
  get model(): Model
}
...
export declare class DownloaderStream {
  next(): Promise<DownloadState | null>
  [Symbol.asyncIterator](): AsyncGenerator<DownloadState, void, undefined>
}
...
export declare class Engine {
  ...
  get downloadStates(): Promise<Record<ModelIdentifier, DownloadState>>
  chat(model: Model, config: ChatConfig): Promise<ChatSession>
  chatInstance(model: Model, config: ChatConfig): Promise<ChatInstance>
  chatWithInstance(instance: ChatInstance): Promise<ChatSession>
...
export declare class EngineConfig {
  ...
  constructor(applicationIdentifier?: string, miraiApiKey?: string, localPath?: string, huggingfaceApiKey?: string, openaiApiKey?: string, anthropicApiKey?: string, geminiApiKey?: string, xaiApiKey?: string, basetenApiKey?: string, openrouterApiKey?: string, allowOllamaUsage: boolean, allowLmstudioUsage: boolean, downloadManagerType: DownloadManagerType)
