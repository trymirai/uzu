...
public func canDelete() -> Bool  {
    ...
    uniffi_download_manager_fn_method_downloadstate_can_delete(
...
public func canPause() -> Bool  {
    return try!  FfiConverterBool.lift(try! rustCall() {
    uniffi_download_manager_fn_method_downloadstate_can_pause(
            FfiConverterTypeDownloadState_lower(self),$0
    )
})
}
...
public func isInProgress() -> Bool  {
    return try!  FfiConverterBool.lift(try! rustCall() {
    uniffi_download_manager_fn_method_downloadstate_is_in_progress(
            FfiConverterTypeDownloadState_lower(self),$0
    )
})
}
...
public func name() -> String  {
    ...
    uniffi_download_manager_fn_method_downloadstate_name(
            FfiConverterTypeDownloadState_lower(self),$0
    )
})
}
...
public func progress() -> Float  {
    ...
    uniffi_download_manager_fn_method_downloadstate_progress(
            FfiConverterTypeDownloadState_lower(self),$0
    )
})
}
