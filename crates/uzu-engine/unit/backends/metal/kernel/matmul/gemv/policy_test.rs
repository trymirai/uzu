...
fn profile(
    ...
    DeviceProfile::new(tuning_tier, size, false)
}
...
fn fp_policy_cases() {
    let cases = [
        (profile(DeviceSize::Large, GpuTuningTier::Apple9), 1, 12288, 1536, true, tile(8, 8, 1)),
        (profile(DeviceSize::Large, GpuTuningTier::Apple9), 1, 12288, 1536, false, tile(8, 1, 1)),
        (profile(DeviceSize::Large, GpuTuningTier::Apple9), 1, 1536, 256, true, tile(8, 1, 1)),
        (profile(DeviceSize::Small, GpuTuningTier::Apple9), 1, 1536, 256, true, tile(8, 2, 1)),
        (profile(DeviceSize::Large, GpuTuningTier::Apple9), 8, 12288, 1536, true, tile(8, 1, 4)),
        (profile(DeviceSize::Large, GpuTuningTier::Apple9), 1, 1536, 12288, true, tile(8, 8, 4)),
        (profile(DeviceSize::Small, GpuTuningTier::Legacy), 1, 262144, 1536, true, tile(8, 1, 4)),
    ];
...
fn quant_policy_cases() {
    let cases = [
        (profile(DeviceSize::Large, GpuTuningTier::Apple9), 1, 256, 1536, 4, false, qtile(2, 1)),
        (profile(DeviceSize::Large, GpuTuningTier::Apple9), 1, 262144, 1536, 4, false, qtile(8, 4)),
        (profile(DeviceSize::Small, GpuTuningTier::Apple9), 1, 1536, 256, 4, false, qtile(4, 4)),
        (profile(DeviceSize::Small, GpuTuningTier::Apple8), 1, 2048, 1536, 4, false, qtile(8, 2)),
        (profile(DeviceSize::Small, GpuTuningTier::Legacy), 1, 256, 1536, 4, false, qtile(8, 2)),
        (profile(DeviceSize::Small, GpuTuningTier::Legacy), 1, 1536, 256, 4, false, qtile(4, 8)),
        (profile(DeviceSize::Large, GpuTuningTier::Apple9), 2, 2048, 1536, 4, false, qtile(8, 4)),
        (profile(DeviceSize::Large, GpuTuningTier::Apple9), 4, 5120, 5120, 4, false, qtile(8, 4)),
        (
            profile(DeviceSize::Large, GpuTuningTier::Apple9),
            1,
            2048,
            1536,
            8,
        ...
        (profile(DeviceSize::Large, GpuTuningTier::Apple9), 1, 2560, 9216, 4, true, qtile(4, 8)),
    ];
...
fn quantized_policy_edges() {
    for (profile, m, group, expected) in [
        (profile(DeviceSize::Large, GpuTuningTier::Apple10), 2, 32, GemvTile::quantized(8, 4, 1, 32, 4)),
        (profile(DeviceSize::Large, GpuTuningTier::Apple10), 3, 32, GemvTile::quantized(8, 4, 1, 32, 4)),
        (profile(DeviceSize::Small, GpuTuningTier::Apple8), 4, 64, GemvTile::quantized(8, 4, 1, 32, 8)),
    ] {
        assert_eq!(quantized(profile, 8, group, m, 4096, 4096, GemmDTransform::RHT), Some(expected));
    }
    let profile = profile(DeviceSize::Large, GpuTuningTier::Apple10);
