...
use backend_uzu::{
    ...
    engine::{
        Engine,
        language_model::grammar::{Grammar, GrammarConfig},
    },
};
...
pub fn main() {
    ...
    let mut grammar = <dyn Grammar>::new(&grammar_config, &tokenizer, None, Some(&stop_token_ids_i32)).unwrap();
    ...
    options.grammar = Some(grammar.as_mut());
