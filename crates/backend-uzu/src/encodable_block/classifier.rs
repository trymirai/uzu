...
use crate::{
    ...
    backends::common::{Allocation, Backend, Encoder, Kernels, kernel::PoolingMeanKernel},
...
impl<B: Backend> Classifier<B> {
    ...
    pub fn encode(
        ...
        let hidden = self
            .transformer
            .encode(hidden, None, batch_dim, Some(0..batch_dim), &MixerTokenTopology::Flat, None, encoder)
