...
template <MatmulMode MODE, typename RightElement, class OutputFragment, class LeftFragment>
METAL_FUNC static void fragment_mma_int8_device_weights(
  ...
  constexpr auto descriptor =
      mpp::tensor_ops::matmul2d_descriptor(FRAGMENT_ROWS, tile_n, tile_k, false, true, RELAXED, MODE);
