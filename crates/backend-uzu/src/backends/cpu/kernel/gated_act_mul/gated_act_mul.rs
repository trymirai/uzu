...
pub fn gated_act_mul<T: ArrayElement + Float>(
    ...
    #[optional(clip_act)] act_clip_min: Option<f32>,
    #[optional(clip_act)] act_clip_max: Option<f32>,
    ...
    for batch in 0..batch_dim {
        ...
        for gated in 0..gated_dim {
            ...
            let activated = if custom_activation_alpha && act_type == ActivationType::SILU {
