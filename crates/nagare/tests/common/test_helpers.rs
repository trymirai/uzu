...
use nagare::{
    ...
    registry::{
        FixedRegistry,
        types::{Accessibility, Entity, EntityType, File, Hash, HashMethod, Model, Reference},
    },
...
fn test_model(index: usize) -> Model {
    ...
    Model {
        entities: vec![vendor_entity, family_entity, model_entity],
        specializations: vec![],
        number_of_parameters: None,
        accessibility: Accessibility::Local {
            provider_identifier: "test".to_string(),
