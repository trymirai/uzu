...
```swift
dependencies: [
    .package(url: "https://github.com/trymirai/uzu.git", from: "0.5.18")
]
```
...
Models downloaded for development are stored at `./workspace/models/0.5.18/`.
...
```bash
cargo run --release -p cli -- bench ./workspace/models/0.5.18/{MODEL_NAME} ./workspace/models/0.5.18/{MODEL_NAME}/benchmark_task.json ./workspace/models/0.5.18/{MODEL_NAME}/benchmark_result.json
```
