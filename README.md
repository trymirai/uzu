...
```swift
dependencies: [
    .package(url: "https://github.com/trymirai/uzu.git", from: "0.5.4")
]
```
...
Models downloaded for development are stored at `./workspace/models/0.5.4/`.
...
```bash
cargo run --release -p cli -- bench ./workspace/models/0.5.4/{MODEL_NAME} ./workspace/models/0.5.4/{MODEL_NAME}/benchmark_task.json ./workspace/models/0.5.4/{MODEL_NAME}/benchmark_result.json
```
